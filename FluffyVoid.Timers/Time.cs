...
namespace FluffyVoid.Timers
{
    ...
    public class Time
    {
        ...
        /// <summary>
        ///     The amount of time the last frame was delayed to meet the desired frame
        ///     rate
        /// </summary>
        ...
        public static int DesiredFrameRate
        {
            set
            {
                if (value < 0)
                {
                    ...
                    Instance._desiredFrameRateTime =
                        1.0 / Instance._desiredFrameRate;
        ...
        /// <summary>
        ///     Calculates the amount of milliseconds to wait in order to maintain a locked
        ///     FPS
        /// </summary>
        ...
        public static void Signal()
        {
            ...
            long currentElapsedMilliseconds =
                Instance._clock.ElapsedMilliseconds;
