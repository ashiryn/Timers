namespace FluffyVoid.Timers
{
    ...
    public static class TimerManager
    {
        ...
        /// </summary>
        private static readonly Queue<Timer> TimersToDestroy =
            new Queue<Timer>();
        ...
        /// <summary>
        ///     Helper function that iterates through the active timers and increments
        ///     their elapsed times, Ticking any that
        ///     qualify
        /// </summary>
        /// <param name="deltaTime">The time since the last update call</param>
