...
{
    /// <summary>
    ///     Event timer that allows for a callback to be called whenever the timer
    ///     Ticks its interval
    /// </summary>
    ...
    public class Timer : IDisposable
    {
        ...
        /// <summary>
        ///     Default constructor that sets a timer to 1 second interval and in an OFF
        ///     state
        /// </summary>
        public Timer()
        {
        ...
        /// <summary>
        ///     Constructor that sets the interval to the passed in value, and the id of
        ///     the timer
        /// </summary>
        /// <param name="interval">The number of seconds to wait between Ticks</param>
        ...
        /// <summary>
        ///     Stops the timer, retaining the currently elapsed time. Call Reset before
        ///     the next Start in order to get a fresh
        ...
        /// </summary>
        /// <param name="time">
        ///     The amount of time to decrement from the currently elapsed
        ///     time
        /// </param>
